...
make_group(gp1,
    ...
    EX(and), EX(sub), EMPTY, EX(cmp)) //dont need decode_ID
...
static OpcodeEntry opcode_table [512] = { //stores OpcodeEntry, which includes decode func and exec func and width of each opcode.
  ...
  /* 0x20 */	IDEXW(G2E,and,1), IDEX(E2G,and), IDEXW(E2G,and,1), IDEX(E2G,and),
  /* 0x24 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x28 */	IDEXW(G2E,sub,1), IDEX(G2E,sub), EMPTY, EMPTY,
  /* 0x2c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x30 */	EMPTY, IDEX(G2E,xor), EMPTY, EMPTY,
  /* 0x34 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x38 */	EMPTY, IDEX(G2E, cmp), EMPTY, IDEXW(G2E,cmp,1),
